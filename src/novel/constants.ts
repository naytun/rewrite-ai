export const AI_INSTRUCTIONS = {
   ...
   1. Rewrite following contents to be in shorter sentences but don't summarize the paragraphs. Do not remove any paragraphs.
	...
	3.	Make the dialogue natural, engaging, and reflective of the characters’ personalities, with subtle hints of subtext.
	4.	Adjust the style and voice to align with the intended tone, such as lyrical, dark, or whimsical.
	5.	Ensure the stakes and conflict feel more gripping and emotionally charged.
	6.	If relevant, transform the passage creatively by experimenting with point of view, changing the setting, or adopting a different narrative perspective`,
}
